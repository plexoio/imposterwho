...
urlpatterns = [
    ...
    path('quizzes/<int:quiz_id>/questions/', views.manage_quiz_questions, name='manage_quiz_questions'),
    ...
    path('questions/<int:question_id>/answers/', views.manage_question_answers, name='manage_question_answers'),
    path('answers/delete/<int:answer_id>/', views.delete_answer, name='delete_answer'),

    # urls.py
    path('dashboard/delete/<str:type>/<int:pk>/', views.delete_object, name='delete_object')
