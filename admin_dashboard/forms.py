...
class QuizQuestionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            "question_text",
            Row(Column("order", css_class="form-group col-md-3"), css_class="form-row"),
...
class QuizAnswerForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"answer_text": "Texto de la respuesta", "is_correct": "¿Es correcta?"}
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                ...
                Column(
                    Field("is_correct", wrapper_class="form-check"),
