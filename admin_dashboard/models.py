...
class MotivationalQuote(models.Model):
    ...
    quote_type = models.ForeignKey(QuoteType, on_delete=models.CASCADE, related_name="motivational_quotes")
...
class EmergencyQuiz(models.Model):
    ...
    category = models.ForeignKey(QuoteType, on_delete=models.CASCADE, related_name="quiz_categories")
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class QuizQuestion(models.Model):
    ...
    quiz = models.ForeignKey(EmergencyQuiz, on_delete=models.CASCADE, related_name='questions')
